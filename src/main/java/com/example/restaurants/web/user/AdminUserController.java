...
import com.example.restaurants.web.AbstractGetDeleteController;
...
public class AdminUserController extends AbstractGetDeleteController {
    ...
    public ResponseEntity<User> createWithPlacement(@Valid @RequestBody User user) {
