package com.example.restaurants.web.user;
...
import com.example.restaurants.util.UsersUtil;
...
import static com.example.restaurants.web.user.ProfileController.REST_URL;
import static com.example.restaurants.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
